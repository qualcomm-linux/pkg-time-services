# Contributing to pkg-time-services
...
1. [Fork](https://github.com/qualcomm-linux/pkg-time-services/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-time-services.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-time-services.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-time-services/pulls) from your branch to `main`.
